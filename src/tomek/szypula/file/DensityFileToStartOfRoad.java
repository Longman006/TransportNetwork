    ...
    void updateFile() {
        ...
        for (Road road :
            ...
            for (Car car :
                ...
                dataWriter.updateFile(String.valueOf(time),road.getId(),car.getId(),String.valueOf(distance),String.valueOf(car.getSpeedDensityIndex()), String.valueOf(car.getSpeed().getLength()));
            }
        }
    }
}
